...
import type { Config, ServerGeminiStreamEvent } from '@aetherai/aether-core';
import { GeminiEventType, OutputFormat } from '@aetherai/aether-core';
    ...
    describe('finalizeAssistantMessage', () => {
        ...
        it('should split different block types into separate assistant messages', () => {
            ...
            const storedMessages = (
                adapter as unknown as { messages: unknown[] }
            ).messages;
