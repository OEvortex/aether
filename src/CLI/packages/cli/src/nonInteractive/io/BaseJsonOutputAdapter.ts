...
export abstract class BaseJsonOutputAdapter {
    ...
    processSubagentToolCall(
        ...
        this.processSubagentToolUseBlock(
            state,
            index,
            toolCall,
            parentToolUseId
    ...
    protected appendThinking(
        ...
        this.ensureBlockTypeConsistency(
            state,
            'thinking',
            actualParentToolUseId
        );
    ...
    protected buildResultMessage(
        ...
        if (options.isError) {
            ...
            const success: CLIResultMessageSuccess & {
                ...
                type: 'result',
                subtype:
                    (options.subtype as CLIResultMessageSuccess['subtype']) ??
                    'success',
                uuid: baseUuid,
                session_id: baseSessionId,
                is_error: false,
