...
import { type Config, Kind } from '@aetherai/aether-core';
...
export function ToolSelector({
    ...
    const {
        ...
        const toolCategories = [
            ...
            (category) => category.id === 'all' || category.tools.length > 0
        );
