...
export function AgentCreationWizard({
    ...
    const renderStepHeader = useCallback(() => {
        const getStepHeaderText = () => {
            ...
            switch (kind) {
                case 'LOCATION':
                    return t('Step {{n}}: Choose Location', {
                        n: n.toString()
                    });
                case 'GEN_METHOD':
                    return t('Step {{n}}: Choose Generation Method', {
                        n: n.toString()
                    });
                case 'LLM_DESC':
                    return t('Step {{n}}: Describe Your Subagent', {
                        n: n.toString()
                    });
                case 'MANUAL_NAME':
                    return t('Step {{n}}: Enter Subagent Name', {
                        n: n.toString()
                    });
                case 'MANUAL_PROMPT':
                    return t('Step {{n}}: Enter System Prompt', {
                        n: n.toString()
                    });
                case 'MANUAL_DESC':
                ...
                case 'COLOR':
                    return t('Step {{n}}: Choose Background Color', {
                        n: n.toString()
                    });
                case 'FINAL':
                    return t('Step {{n}}: Confirm and Save', {
                        n: n.toString()
                    });
                default:
    ...
    const renderStepFooter = useCallback(() => {
        const getNavigationInstructions = () => {
            ...
            if (
                getStepKind(state.generationMethod, state.currentStep) ===
                'FINAL'
            ) {
                return t(
