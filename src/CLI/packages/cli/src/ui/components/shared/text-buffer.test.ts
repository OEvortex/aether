...
describe('textBufferReducer', () => {
    it('should return the initial state if state is undefined', () => {
        const action = {
            type: 'unknown_action'
        } as unknown as TextBufferAction;
    ...
    describe('undo/redo actions', () => {
        it('should undo and redo a change', () => {
            ...
            const stateAfterInsert = textBufferReducer(
                initialState,
                insertAction
            );
            ...
            const stateAfterUndo = textBufferReducer(
                stateAfterInsert,
                undoAction
            );
            ...
            const stateAfterRedo = textBufferReducer(
                stateAfterUndo,
                redoAction
            );
