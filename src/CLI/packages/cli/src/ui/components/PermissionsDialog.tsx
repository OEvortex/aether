...
export function PermissionsDialog({
    ...
    const [deleteTarget, setDeleteTarget] = useState<RuleWithSource | null>(
        null
    );
    ...
    const handleTabCycle = useCallback(
        (direction: 1 | -1) => {
            const newIndex =
                (activeTabIndex + direction + tabs.length) % tabs.length;
                    ...
                    <TextInput
                        ...
                        onTab={
                            dirCompletions.length > 0
                                ? handleDirTabComplete
                                : undefined
                        }
                        onUp={
                            dirCompletions.length > 0
                                ? handleDirCompletionUp
                                : undefined
                        }
                        onDown={
                            dirCompletions.length > 0
                                ? handleDirCompletionDown
                                : undefined
                        }
