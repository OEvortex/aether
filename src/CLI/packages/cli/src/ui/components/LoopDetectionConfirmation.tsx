                ...
                <Box width="100%" marginTop={1}>
                    <Box flexDirection="column">
                        <Text color={theme.text.secondary}>
                            This can happen due to repetitive tool calls or
                            other model behavior. Do you want to keep loop
                        ...
                        <Box marginTop={1}>
                            <Text color={theme.text.secondary}>
                                Note: To disable loop detection checks for all
                                future sessions, set
                                &quot;model.skipLoopDetection&quot; to true in
                                your settings.json.
                            </Text>
                        </Box>
                    </Box>
