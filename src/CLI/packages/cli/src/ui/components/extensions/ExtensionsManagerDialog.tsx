...
import { createDebugLogger, SettingScope } from '@aetherai/aether-core';
...
export function ExtensionsManagerDialog({
    ...
    const handleSelectExtension = useCallback((extensionIndex: number) => {
        ...
        setNavigationStack((prev) => [
            ...prev,
            MANAGEMENT_STEPS.ACTION_SELECTION
        ]);
    }, []);
            ...
            switch (action) {
                ...
                case 'uninstall':
                    handleNavigateToStep(
                        MANAGEMENT_STEPS.UNINSTALL_CONFIRMATION
                    );
                    break;
                default:
                    break;
    ...
    useKeypress(
        (key) => {
            ...
            if (
                successMessage &&
                currentStep === MANAGEMENT_STEPS.EXTENSION_LIST
            ) {
                setSuccessMessage(null);
                return;
            }
