        ...
        <>
            ...
            >
                <Box flexDirection="column" paddingBottom={1}>
                    ...
                    <Text>
                        Current Level:{' '}
                        <Text bold>{currentTrustLevel || 'Not Set'}</Text>
                    </Text>
                    {isInheritedTrustFromParent && (
                        <Text color={theme.text.secondary}>
                            Note: This folder behaves as a trusted folder
                            because one of the parent folders is trusted. It
                            will remain trusted even if you set a different
                            trust level here. To change this, you need to modify
                    ...
                    {isInheritedTrustFromIde && (
                        <Text color={theme.text.secondary}>
                            Note: This folder behaves as a trusted folder
                            because the connected IDE workspace is trusted. It
                            will remain trusted even if you set a different
                            trust level here.
                        </Text>
                    )}
            ...
            {needsRestart && (
                <Box marginLeft={1} marginTop={1}>
                    <Text color={theme.status.warning}>
                        To apply the trust changes, Aether Code must be
                        restarted. Press &apos;r&apos; to restart CLI now.
                    </Text>
                </Box>
            )}
        </>
