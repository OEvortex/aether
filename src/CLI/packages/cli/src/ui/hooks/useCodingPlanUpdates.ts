...
import { buildModelProvidersConfigFromProviderRegistry } from '../auth/providerSelection.js';
...
export function useCodingPlanUpdates(
        ...
        async (region: CodingPlanRegion = CodingPlanRegion.CHINA) => {
            try {
                ...
                const currentConfigs =
                    currentModelProviders?.[AuthType.USE_OPENAI] || [];
                ...
                const updatedConfigs = [
                    ...newConfigs,
                    ...(nonCodingPlanConfigs as unknown as Array<
                        Record<string, unknown>
                    >)
    ...
    const checkForUpdates = useCallback(() => {
        ...
        const region =
            mergedSettings.codingPlan?.region ?? CodingPlanRegion.CHINA;
