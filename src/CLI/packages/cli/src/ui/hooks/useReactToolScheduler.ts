...
import { CoreToolScheduler, createDebugLogger } from '@aetherai/aether-core';
                ...
                updatedCoreToolCalls.map((coreTc) => {
                    ...
                    if (coreTc.status === 'executing') {
                        return {
                            ...
                            liveOutput: (
                                existingTrackedCall as TrackedExecutingToolCall
                            )?.liveOutput,
...
function mapCoreStatusToDisplayStatus(coreStatus: CoreStatus): ToolCallStatus {
    switch (coreStatus) {
        ...
        default: {
            ...
            debugLogger.warn(
                `Unknown core status encountered: ${exhaustiveCheck}`
            );
            return ToolCallStatus.Error;
        }
    }
            ...
            switch (trackedCall.status) {
                case 'success':
                    return {
                        ...
                        status: mapCoreStatusToDisplayStatus(
                            trackedCall.status
                        ),
                ...
                case 'executing':
                    return {
                        ...
                        resultDisplay:
                            (trackedCall as TrackedExecutingToolCall)
                                .liveOutput ?? undefined,
                        confirmationDetails: undefined,
                ...
                default: {
                    ...
                    return {
                        callId: (exhaustiveCheck as TrackedToolCall).request
                            .callId,
                        name: 'Unknown Tool',
