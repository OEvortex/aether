...
describe('useCommandCompletion', () => {
    ...
    describe('Core Hook Behavior', () => {
        describe('State Management', () => {
            ...
            it('should reset state when completion mode becomes IDLE', async () => {
                setupMocks({
                    atSuggestions: [
                        { label: 'src/file.txt', value: 'src/file.txt' }
                    ]
                });
                ...
                await waitFor(() => {
                    expect(result.current.completion.suggestions).toHaveLength(
                        1
                    );
                });
                ...
                await waitFor(() => {
                    expect(result.current.completion.showSuggestions).toBe(
                        false
                    );
                });
            });
    ...
    describe('handleAutocomplete', () => {
        ...
        it('should complete a file path', async () => {
            setupMocks({
                atSuggestions: [
                    { label: 'src/file1.txt', value: 'src/file1.txt' }
                ]
            });
