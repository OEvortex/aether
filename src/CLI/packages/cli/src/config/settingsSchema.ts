    ...
    model: {
        ...
        properties: {
            ...
            sessionTokenLimit: {
                ...
                description:
                    'The maximum number of tokens allowed in a session.',
                showInDialog: false
            },
            ...
            skipLoopDetection: {
                ...
                default: true,
                description:
                    'Disable all loop detection checks (streaming and LLM).',
                showInDialog: false
            },
            skipStartupContext: {
                type: 'boolean',
    ...
    context: {
        ...
        properties: {
            ...
            loadFromIncludeDirectories: {
                ...
                default: false,
                description:
                    'Whether to load memory files from include directories.',
                showInDialog: false
            },
            fileFiltering: {
                type: 'object',
                ...
                properties: {
                    ...
                    respectQwenIgnore: {
                        ...
                        default: true,
                        description:
                            'Respect .aetherignore files when searching',
                        showInDialog: true
                    },
                    enableRecursiveFileSearch: {
                        ...
                        default: true,
                        description:
                            'Enable recursive file search functionality',
                        showInDialog: false
                    },
                    enableFuzzySearch: {
                        type: 'boolean',
    ...
    agents: {
        ...
        properties: {
            ...
            arena: {
                ...
                default: {},
                description:
                    'Settings for Arena (multi-model competitive execution).',
                showInDialog: false,
                properties: {
                    worktreeBaseDir: {
                        type: 'string',
    ...
    hooks: {
        ...
        properties: {
            ...
            PostToolUse: {
                ...
                default: [],
                description:
                    'Hooks that execute after successful tool execution.',
                showInDialog: false,
                mergeStrategy: MergeStrategy.CONCAT,
                items: HOOK_DEFINITION_ITEMS
            },
            ...
            SessionStart: {
                ...
                default: [],
                description:
                    'Hooks that execute when a new session starts or resumes.',
                showInDialog: false,
                mergeStrategy: MergeStrategy.CONCAT,
                items: HOOK_DEFINITION_ITEMS
            },
            ...
            PreCompact: {
                ...
                default: [],
                description:
                    'Hooks that execute before conversation compaction.',
                showInDialog: false,
                mergeStrategy: MergeStrategy.CONCAT,
                items: HOOK_DEFINITION_ITEMS
            },
