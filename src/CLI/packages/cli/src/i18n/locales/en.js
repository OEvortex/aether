...
export default {
    ...
    'Add MCP servers to your settings to get started.':
        'Add MCP servers to your settings to get started.',
    'Run aether --debug to see error logs':
        'Run aether --debug to see error logs',
    ...
    'Aether OAuth Authentication Timeout':
        'Aether OAuth Authentication Timeout',
    ...
    'Saved in .aether/settings.local.json':
        'Saved in .aether/settings.local.json',
    'Project settings': 'Project settings',
    'Checked in at .aether/settings.json':
        'Checked in at .aether/settings.json',
    'User settings': 'User settings',
    'Saved in at ~/.aether/settings.json':
        'Saved in at ~/.aether/settings.json',
    ...
    '  aether auth                - Interactive authentication setup\n':
        '  aether auth                - Interactive authentication setup\n',
    '✓ Authentication Method: Aether OAuth':
        '✓ Authentication Method: Aether OAuth',
