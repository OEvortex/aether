...
import type { TodoItem, TodoWriteParams } from './todoWrite.js';
import { listTodoSessions, TodoWriteTool } from './todoWrite.js';
...
describe('TodoWriteTool', () => {
    ...
    describe('tool properties', () => {
        ...
        it('should have schema with required properties', () => {
            ...
            expect(schema.parametersJsonSchema).toHaveProperty(
                'properties.todos'
            );
