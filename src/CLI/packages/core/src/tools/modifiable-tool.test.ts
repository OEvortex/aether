...
describe('modifyWithEditor', () => {
    ...
    beforeEach(async () => {
        ...
        mockModifyContext = {
            ...
            createUpdatedParams: vi
                .fn()
                .mockImplementation(
                    (oldContent, modifiedContent, originalParams) => ({
                        ...originalParams,
                        modifiedContent,
                        oldContent
                    })
    ...
    describe('successful modification', () => {
        it('should successfully modify content with VSCode editor', async () => {
            ...
            expect(mockModifyContext.getFilePath).toHaveBeenCalledWith(
                mockParams
            );
    ...
    it('should create temp files with correct naming with extension', async () => {
        ...
        expect(oldFilePath).toMatch(
            /aether-cli-modify-test-file-old-\d+\.txt$/
        );
        expect(newFilePath).toMatch(
            /aether-cli-modify-test-file-new-\d+\.txt$/
        );
