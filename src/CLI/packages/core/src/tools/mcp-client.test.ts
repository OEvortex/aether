...
describe('mcp-client', () => {
    ...
    describe('McpClient', () => {
        it('should discover tools', async () => {
            ...
            const mockedMcpToTool = vi
                .mocked(GenAiLib.mcpToTool)
                .mockReturnValue({
                    tool: () => ({
    ...
    describe('appendMcpServerCommand', () => {
        ...
        it('should handle error if mcpServerCommand parsing fails', () => {
            expect(() =>
                populateMcpServerCommand({}, 'derp && herp')
            ).toThrowError();
        });
    });
    ...
    describe('createTransport', () => {
        describe('should connect via httpUrl', () => {
            it('without headers', async () => {
                ...
                expect((transport as any)._url).toEqual(
    ...
    describe('isEnabled', () => {
        ...
        it('should return false if the tool is in the exclude list', () => {
            ...
            expect(isEnabled(funcDecl, serverName, mcpServerConfig)).toBe(
                false
            );
        });
        ...
        it('should return false if the function declaration has no name', () => {
            ...
            const mcpServerConfig = {};
            expect(
                isEnabled(namelessFuncDecl, serverName, mcpServerConfig)
            ).toBe(false);
        });
    });
