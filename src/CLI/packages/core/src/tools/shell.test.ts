...
describe('ShellTool', () => {
        ...
        mockConfig = {
            ...
            storage: {
                getUserSkillsDirs: vi
                    .fn()
                    .mockReturnValue(['/test/dir/.aether/skills']),
    ...
    describe('isCommandAllowed', () => {
        it('should allow a command if no restrictions are provided', async () => {
            ...
            expect((await isCommandAllowed('ls -l', mockConfig)).allowed).toBe(
                true
            );
        });
    ...
    describe('execute', () => {
        ...
        it('should clean up the temp file on synchronous execution error', async () => {
            ...
            await expect(invocation.execute(mockAbortSignal)).rejects.toThrow(
                error
            );
