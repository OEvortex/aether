...
> {
    ...
    override async getDefaultPermission(): Promise<PermissionDecision> {
        ...
        try {
            ...
            debugLogger.warn(
                'AST read-only check failed, falling back to ask:',
                e
            );
        }
    ...
    override async getConfirmationDetails(
        ...
        for (const sub of subCommands) {
            ...
            if (pm) {
                try {
                    ...
                    debugLogger.warn(
                        'PermissionManager command check failed:',
                        e
                    );
                }
            }
        ...
        const effectiveSubCommands =
            confirmableSubCommands.length > 0
                ...
                await ShellExecutionService.execute(
                    ...
                    (event: ShellOutputEvent) => {
                        ...
                        switch (event.type) {
                            ...
                            default: {
                                throw new Error(
                                    'An unhandled ShellOutputEvent was found.'
                                );
                            }
                        }
            ...
            if (result.aborted) {
                ...
                if (wasTimeout) {
                    ...
                    if (result.output.trim()) {
                        ...
                        llmContent +=
                            ' There was no output before it was cancelled.';
                    }
                }
            } else {
