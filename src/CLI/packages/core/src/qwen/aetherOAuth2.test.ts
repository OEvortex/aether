        ...
        it('should return false for successful responses', () => {
            const successResponse: DeviceAuthorizationResponse = {
                ...
                verification_uri_complete:
                    'https://chat.aether.dev/device?code=TEST123',
                expires_in: 1800
            };
...
describe('Utility Functions', () => {
    describe('objectToUrlEncoded', () => {
        ...
        it('should handle special characters', async () => {
            ...
            expect(result).toContain(
                'param%3Dwith%3Dequals=value%3Dwith%3Dequals'
            );
        });
    ...
    describe('getQwenCachedCredentialPath', () => {
        it('should return correct path to cached credentials', async () => {
            ...
            const { promises: fs } = await import('node:fs');
            const { clearAetherCredentials } = await import(
                './aetherOAuth2.js'
            );
...
describe('Enhanced Error Handling and Edge Cases', () => {
    ...
    describe('Enhanced refreshAccessToken scenarios', () => {
        ...
        it('should include resource_url when provided in response', async () => {
            ...
            const credentials = client.getCredentials();
            expect(credentials.resource_url).toBe(
...
describe('SharedTokenManager Integration in AetherOAuth2Client', () => {
    ...
    it('should handle TokenManagerError types correctly in getaetherOAuthClient', async () => {
        ...
        const tokenErrors = [
            ...
            {
                type: TokenError.REFRESH_FAILED,
