...
export class OAuthUtils {
    ...
    static async discoverOAuthConfig(serverUrl) {
        try {
            ...
            let resourceMetadata = await OAuthUtils.fetchProtectedResourceMetadata(wellKnownUrls.protectedResource);
            ...
            if (!resourceMetadata) {
                ...
                if (url.pathname && url.pathname !== '/') {
                    ...
                    resourceMetadata =
                        await OAuthUtils.fetchProtectedResourceMetadata(pathBasedUrls.protectedResource);
                }
            }
