...
import { matchesRule, parseRule, parseRules, resolveToolName, splitCompoundCommand } from './rule-parser.js';
    ...
    evaluateSingle(ctx) {
        ...
        if (toolName === 'run_shell_command' && command !== undefined) {
            ...
            if (virtualDecision !== 'default' &&
                DECISION_PRIORITY[virtualDecision] >
                    DECISION_PRIORITY[baseDecision]) {
