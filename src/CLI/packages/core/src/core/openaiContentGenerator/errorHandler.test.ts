...
describe('EnhancedErrorHandler', () => {
    ...
    describe('handle method', () => {
        ...
        it('should use custom suppression function', () => {
            ...
            expect(suppressLogging).toHaveBeenCalledWith(
                originalError,
                mockRequest
            );
        });
    ...
    describe('timeout error detection', () => {
        ...
        const timeoutErrorCases = [
            ...
            { name: 'etimedout', error: new Error('ETIMEDOUT error') },
            {
                ...
                error: new Error('ESOCKETTIMEDOUT error')
            },
            {
    ...
    describe('ErrorHandler interface compliance', () => {
        it('should implement ErrorHandler interface correctly', () => {
            ...
            expect(typeof errorHandler.shouldSuppressErrorLogging).toBe(
                'function'
            );
            ...
            expect(
                errorHandler.shouldSuppressErrorLogging(
                    new Error('test'),
                    mockRequest
                )
            ).toBe(false);
