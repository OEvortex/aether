...
export class ShellExecutionService {
    ...
    private static childProcessFallback(
        ...
        try {
            ...
            commandToExecute = applyPowerShellUtf8Prefix(
                commandToExecute,
                shell
            );
            ...
            const result = new Promise<ShellExecutionResult>((resolve) => {
                ...
                const handleOutput = (
                    ...
                    if (isStreamingRawContent) {
                        const decoder =
                            stream === 'stdout' ? stdoutDecoder : stderrDecoder;
                ...
                child.on('exit', (code, signal) => {
                    if (child.pid) {
                        ShellExecutionService.activeChildProcesses.delete(
                            child.pid
                        );
                    }
        ...
        try {
            ...
            const result = new Promise<ShellExecutionResult>((resolve) => {
                ...
                const renderFn = () => {
                    ...
                    const trimmedOutput = newOutput.slice(
                        0,
                        lastNonEmptyLine + 1
                    );
