                    ...
                    hooks: [
                        {
                            type: HookType.Command,
                            command:
                                'chmod +x ${CLAUDE_PLUGIN_ROOT}/bin/executable.sh'
                        }
                    ]
                }
            ]
            ...
            PreToolUse: [
                {
                    ...
                    hooks: [
                        // HookConfig[] array inside HookDefinition
                        {
                            ...
                            command:
                                '${CLAUDE_PLUGIN_ROOT}/scripts/pre-start.sh'
                        }
                    ]
                }
            ],
