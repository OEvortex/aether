...
describe('git extension helpers', () => {
    ...
    describe('cloneFromGit', () => {
        ...
        it('should throw if no remotes are found', async () => {
            ...
            await expect(
                cloneFromGit(installMetadata, destination)
            ).rejects.toThrow(
    ...
    describe('findReleaseAsset', () => {
        const assets = [
            ...
            {
                name: 'darwin.x64.extension.tar.gz',
                browser_download_url: 'url2'
            },
            {
                name: 'linux.x64.extension.tar.gz',
                browser_download_url: 'url3'
            },
            {
                name: 'win32.x64.extension.tar.gz',
