...
describe('Server Config (config.ts)', () => {
    ...
    it('should store a system prompt override', () => {
        ...
        expect(config.getSystemPrompt()).toBe(
    ...
    describe('initialize', () => {
        it('should throw an error if checkpointing is enabled and GitService fails', async () => {
            ...
            (GitService.prototype.initialize as Mock).mockRejectedValue(
                gitError
            );
    ...
    describe('refreshAuth', () => {
        it('should refresh auth and update config', async () => {
            ...
            expect(config.getContentGeneratorConfig()).toEqual(
                mockContentConfig
            );
    ...
    describe('model switching with different credentials (OpenAI)', () => {
        it('should refresh auth when switching to model with different envKey', async () => {
            ...
            vi.mocked(
                resolveContentGeneratorConfigWithSources
            ).mockImplementation((_config, _authType, generationConfig) => {
    ...
    describe('Usage Statistics', () => {
        ...
        it('logs the session start event', async () => {
            ...
            expect(
                AetherLogger.prototype.logStartSessionEvent
    ...
    describe('createToolRegistry', () => {
        ...
        it('should register a tool if coreTools contains a legacy tool name alias', async () => {
            ...
            const wasGrepToolRegistered = (
                registerToolMock as Mock
            ).mock.calls.some((call) => call[0] instanceof vi.mocked(GrepTool));
...
describe('setApprovalMode with folder trust', () => {
    ...
    describe('registerCoreTools', () => {
        ...
        it('should register RipGrepTool when useRipgrep is true and it is available', async () => {
            ...
            const calls = (ToolRegistry.prototype.registerTool as Mock).mock
                .calls;
