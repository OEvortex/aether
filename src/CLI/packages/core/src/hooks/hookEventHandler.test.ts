...
describe('HookEventHandler', () => {
    ...
    describe('fireSessionEndEvent', () => {
        ...
        it('should handle different session end reasons', async () => {
            ...
            for (const reason of testReasons) {
                ...
                const mockCalls = (mockHookRunner.executeHooksParallel as Mock)
                    .mock.calls;
    ...
    describe('firePostToolUseFailureEvent', () => {
        ...
        it('should handle multiple hooks execution', async () => {
            ...
            expect(mockHookRunner.executeHooksParallel).toHaveBeenCalledTimes(
                1
            );
    ...
    describe('firePreCompactEvent', () => {
        ...
        it('should handle both trigger types correctly', async () => {
            ...
            let mockCalls = (mockHookRunner.executeHooksParallel as Mock).mock
                .calls;
            ...
            // Test Auto trigger
            await hookEventHandler.firePreCompactEvent(PreCompactTrigger.Auto);
            mockCalls = (mockHookRunner.executeHooksParallel as Mock).mock
                .calls;
            ...
            const mockAggregated = createMockAggregatedResult(true, {
                ...
                hookSpecificOutput: {
                    ...
                    decision: {
                        behavior: 'deny',
                        message:
                            'Destructive system command blocked by security hook',
                        interrupt: true
                    }
                }
            });
    ...
    describe('telemetry', () => {
        ...
        it('should call logHookCall for each hook execution', async () => {
            ...
            const result1 = createMockHookExecutionResult(
                true,
                hookConfig1,
                50
            );
            const result2 = createMockHookExecutionResult(
                true,
                hookConfig2,
                75
            );
