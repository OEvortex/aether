...
import { logArenaAgentCompleted, logArenaSessionEnded, logArenaSessionStarted, makeArenaAgentCompletedEvent, makeArenaSessionEndedEvent, makeArenaSessionStartedEvent } from '../../telemetry/index.js';
...
import { AgentStatus, isSettledStatus, isSuccessStatus, isTerminalStatus } from '../runtime/agent-types.js';
import { ArenaEventEmitter, ArenaEventType } from './arena-events.js';
import { ARENA_MAX_AGENTS, ArenaSessionStatus, safeAgentId } from './types.js';
...
export class ArenaManager {
    ...
    validateStartOptions(options) {
        ...
        if (uniqueSafeIds.size !== safeIds.length) {
            const collisions = modelIds.filter((_id, i) => safeIds.indexOf(safeIds[i]) !== i);
