...
export const EVENT_CONTENT_RETRY_FAILURE = 'aether-cli.chat.content_retry_failure';
export const EVENT_CONVERSATION_FINISHED = 'aether-cli.conversation_finished';
export const EVENT_MALFORMED_JSON_RESPONSE = 'aether-cli.malformed_json_response';
