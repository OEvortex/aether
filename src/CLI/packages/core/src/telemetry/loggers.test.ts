...
describe('loggers', () => {
    ...
    describe('logChatCompression', () => {
        ...
        it('logs the chat compression event to AetherLogger', () => {
            ...
            expect(
                AetherLogger.prototype.logChatCompressionEvent
    ...
    describe('logRipgrepFallback', () => {
        ...
        it('should log ripgrep fallback event', () => {
            ...
            expect(
                AetherLogger.prototype.logRipgrepFallbackEvent
            ).toHaveBeenCalled();
    ...
    describe('logExtensionEnable', () => {
        ...
        it('should log extension enable event', () => {
            ...
            expect(
                AetherLogger.prototype.logExtensionEnableEvent
            ).toHaveBeenCalledWith(event);
    ...
    describe('logHookCall', () => {
        ...
        it('should log a successful hook call to AetherLogger', () => {
            ...
            expect(mockAetherLogger.logHookCallEvent).toHaveBeenCalledWith(
                event
            );
        });
        ...
        it('should pass the exact event object to AetherLogger', () => {
            ...
            const passedEvent =
                mockAetherLogger.logHookCallEvent.mock.calls[0][0];
