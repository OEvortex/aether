...
describe('Telemetry Metrics', () => {
    ...
    beforeEach(async () => {
        ...
        vi.doMock('@opentelemetry/api', () => {
            ...
            (actualApi.metrics.getMeter as Mock).mockReturnValue(
                mockMeterInstance
            );
            return actualApi;
        });
        ...
        recordApiRequestBreakdownModule =
            metricsJsModule.recordApiRequestBreakdown;
        ...
        (otelApiModule.metrics.getMeter as Mock).mockReturnValue(
            mockMeterInstance
        );
    ...
    describe('Performance Monitoring Metrics', () => {
        ...
        describe('recordStartupPerformance', () => {
            ...
            it('should record startup performance without details', () => {
                ...
                recordStartupPerformanceModule(mockConfig, 50, {
                    phase: 'cleanup'
                });
        ...
        describe('recordBaselineComparison', () => {
            ...
            it('should skip recording when baseline is zero', async () => {
                ...
                const mockedModule = (await vi.importMock(
                    '@opentelemetry/api'
                )) as {
