...
export class JsonSchemaProvider {
                ...
                'chp-settings',
                {
                    provideTextDocumentContent: (uri: vscode.Uri): string => {
                        if (uri.toString() === JsonSchemaProvider.SCHEMA_URI) {
                            const schema =
                                JsonSchemaProvider.getProviderOverridesSchema();
    ...
    private static createProviderSchema(
        ...
        const modelProperty: JSONSchema7 = {
            ...
            minLength: 1,
            description:
                'Override model name or endpoint ID used for API requests'
        };
                ...
                ...(providerKey === 'ollama'
                    ? {
                          baseUrl: {
                              type: 'string',
                              description:
                                  'Override provider-level API base URL',
                              format: 'uri'
                          }
                      }
                    : {}),
                    ...
                    items: {
                        ...
                        properties: {
                            ...
                            baseUrl: {
                                type: 'string',
                                description:
                                    'Override model-level API base URL',
                                format: 'uri'
                            },
                            outputThinking: {
                                type: 'boolean',
