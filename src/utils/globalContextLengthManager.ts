...
const GLM5_MAX_INPUT_TOKENS = GLM5_TOTAL_TOKENS - GLM5_MAX_OUTPUT_TOKENS;
...
const _QWEN_PLUS_TOTAL_TOKENS = 256 * TOKENS_PER_KIBI;
const _QWEN_PLUS_MAX_OUTPUT_TOKENS = 32 * TOKENS_PER_KIBI;
